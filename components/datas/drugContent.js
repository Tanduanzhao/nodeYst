        ...
        return(
          <div className="root" style={{"overflow":"auto"}}>
              ...
              <div className="drugContent-main">
                  ...
                  <div className="message">
                      <div>三级：{this.props.drugContentData.prodLevel3Count} / {this.props.drugContentData.level3Count}</div>
                      <div>二级：{this.props.drugContentData.prodLevel2Count} / {this.props.drugContentData.level2Count}</div>
                      <div>一级及一级以下：{this.props.drugContentData.prodLevel1Count} / {this.props.drugContentData.level1Count}</div>
                  </div>
