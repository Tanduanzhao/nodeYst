...
class List extends Component{
    render(){
        ...
        return(
        <Link to={`/market/MarketSearch/marketSearchDetail/${this.props.dataSources.genericName}/${this.props.dataSources.id}`} className="row item" style={{ padding: '10px',fontSize: '.6rem'}}>
